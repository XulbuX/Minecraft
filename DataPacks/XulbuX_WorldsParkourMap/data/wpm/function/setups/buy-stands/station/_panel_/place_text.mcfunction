...
# FREEZE-BOMB
   execute if entity @s[tag=buy_freeze_bomb] at @s run execute positioned ~ ~1 ~ unless entity @e[tag=text2_freeze_bomb,distance=...001] run summon text_display ~ ~ ~ {Tags:["text2_freeze_bomb","buy_text"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[.605f,.605f,.605f]},billboard:"vertical",see_through:0b,line_width:1000,alignment:"left",background:-939524096,text:'["",{"text":" Buy this special ","color":"gold"},{"text":"Race-Item","bold":true,"color":"yellow"},{"text":"! ","color":"gold"},"\\n",{"text":" >> ","color":"#5E64FF"},{"text":"Costs for one = ","color":"#7E82FF"},{"text":"$40","color":"green"},"\\n\\n",{"text":" ","color":"#DDDDDD"},{"text":"[","bold":true,"color":"dark_gray"},{"text":"▲","bold":true,"color":"#43FFAA"},{"text":"▼","bold":true,"color":"#FF004D"},{"text":"]","bold":true,"color":"dark_gray"},{"text":" ","bold":true},{"text":"Amount to buy: ","color":"#DDDDDD"},{"text":"...","color":"light_purple"},{"text":"pcs","color":"#D000D0"},"\\n",{"text":"          Total costs: ","color":"#DDDDDD"},{"text":"$","color":"#D0A600"},{"text":"...  ","color":"#FFCC00"},{"text":"$","color":"#D54848"},{"text":"...","color":"red"},"\\n",{"text":" >> ","color":"#CC3300"},{"text":"not enough money! ","color":"#FF0000"}]'}
   execute if entity @s[tag=buy_freeze_bomb] at @s run execute positioned ~ ~2.25 ~ unless entity @e[tag=text1_freeze_bomb,distance=...001] run summon text_display ~ ~ ~ {Tags:["text1_freeze_bomb","buy_text"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[.5f,.5f,.5f]},billboard:"vertical",see_through:0b,line_width:1000,alignment:"center",background:1679909532,text:'["",{"text":" The ","color":"#CCFFFF"},{"text":"Freeze Bomb","bold":true,"color":"aqua"},{"text":" is a bomb that \\n can be thrown. Every mob/player \\n that comes within a ","color":"#CCFFFF"},{"text":"radius of 5 \\n blocks","color":"#00CCFF"},{"text":" of the bomb in the air is \\n completely ","color":"#CCFFFF"},{"text":"frozen for 10 seconds","color":"#00CCFF"},{"text":". ","color":"#CCFFFF"}]'}
# LANDMINE
   # ...
