# ACTIVATE / DEACTIVATE / RESET SNAKE
   ...
   execute if entity @s[tag=!reset] at @s if entity @a[distance=..25,nbt={SelectedItem:{components:{"minecraft:custom_data":{wpm_snake_block_spawnegg:1}}}}] run tag @s add reset
